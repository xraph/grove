...
func BenchmarkInsert_Grove(b *testing.B) {
	sdb := newGroveDB(b)
	ctx := context.Background()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkInsert_Bun(b *testing.B) {
	db := newBunDB(b)
	ctx := context.Background()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkSelectOne_RawSQL(b *testing.B) {
	db := newRawDB(b)
	seedUsers(b, db, 100)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkSelectOne_Grove(b *testing.B) {
	sdb := newGroveDB(b)
	ctx := context.Background()
	// Seed via Grove
	for i := 0; i < 100; i++ {
...
func BenchmarkSelectOne_Bun(b *testing.B) {
	db := newBunDB(b)
	ctx := context.Background()
	// Seed
	for i := 0; i < 100; i++ {
...
func BenchmarkSelectMulti_RawSQL(b *testing.B) {
	db := newRawDB(b)
	seedUsers(b, db, 200)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkSelectMulti_Grove(b *testing.B) {
	sdb := newGroveDB(b)
	ctx := context.Background()
	for i := 0; i < 200; i++ {
		u := sampleUser(i)
...
func BenchmarkSelectMulti_Bun(b *testing.B) {
	db := newBunDB(b)
	ctx := context.Background()
	for i := 0; i < 200; i++ {
		u := sampleUser(i)
...
func BenchmarkSelectMulti_GORM(b *testing.B) {
	db := newGormDB(b)
	for i := 0; i < 200; i++ {
		u := sampleUser(i)
		db.Create(&u)
...
func BenchmarkUpdate_Grove(b *testing.B) {
	sdb := newGroveDB(b)
	ctx := context.Background()
	for i := 0; i < 100; i++ {
		u := sampleUser(i)
...
func BenchmarkDelete_RawSQL(b *testing.B) {
	db := newRawDB(b)
...
func BenchmarkDelete_Grove(b *testing.B) {
	sdb := newGroveDB(b)
	ctx := context.Background()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkBulkInsert100_RawSQL(b *testing.B) {
	db := newRawDB(b)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		b.StopTimer()
...
func BenchmarkBulkInsert100_Grove(b *testing.B) {
	sdb := newGroveDB(b)
	ctx := context.Background()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkBulkInsert100_Bun(b *testing.B) {
	db := newBunDB(b)
	ctx := context.Background()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkBulkInsert100_GORM(b *testing.B) {
	db := newGormDB(b)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		b.StopTimer()
...
func BenchmarkBuild_Select_Grove(b *testing.B) {
	sdb := newGroveDB(b)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkBuild_Select_Bun(b *testing.B) {
	db := newBunDB(b)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkBuild_Insert_Grove(b *testing.B) {
	sdb := newGroveDB(b)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		u := sampleUser(i)
...
func BenchmarkBuild_Insert_Bun(b *testing.B) {
	db := newBunDB(b)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		u := sampleUser(i)
...
func BenchmarkBuild_Update_Grove(b *testing.B) {
	sdb := newGroveDB(b)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkBuild_Update_Bun(b *testing.B) {
	db := newBunDB(b)
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
