...
func TestSqliteDialect_GoToDBType(t *testing.T) {
	d := &SqliteDialect{}
...
func TestSqliteDialect_AppendTime(t *testing.T) {
	d := &SqliteDialect{}
...
func TestSqliteDialect_AppendTime_WithTimezone(t *testing.T) {
	d := &SqliteDialect{}
...
func TestSqliteDialect_AppendBytes(t *testing.T) {
	d := &SqliteDialect{}
...
func TestSqliteDialect_AppendBytes_Appends(t *testing.T) {
	d := &SqliteDialect{}
