...
func newTestDB() *SqliteDB {
	return &SqliteDB{dialect: &SqliteDialect{}, registry: schema.NewRegistry()}
}
...
func TestSqliteDB_GroveSelect_MatchesNewSelect(t *testing.T) {
	db := newTestDB()
...
func TestSqliteDB_GroveInsert_MatchesNewInsert(t *testing.T) {
	db := newTestDB()
...
func TestSqliteDB_GroveUpdate_MatchesNewUpdate(t *testing.T) {
	db := newTestDB()
...
func TestSqliteDB_GroveDelete_MatchesNewDelete(t *testing.T) {
	db := newTestDB()
	post := &TestPost{ID: 1}
