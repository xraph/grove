// Package sqlitedriver provides a SQLite driver for the Grove ORM,
// built on top of database/sql with modernc.org/sqlite (pure Go, no CGo).
...
var _ driver.Dialect = (*SqliteDialect)(nil)
...
// Placeholder returns the SQLite parameter placeholder. SQLite uses ? for
// all positional parameters regardless of position.
